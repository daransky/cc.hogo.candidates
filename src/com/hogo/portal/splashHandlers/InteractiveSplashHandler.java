...
package com.hogo.portal.splashHandlers;
...
public class InteractiveSplashHandler extends AbstractSplashHandler {
	...
	private void handleButtonOKWidgetSelected() {
		try {
			...
			UIError.showError(getSplash(), "Anmeldung ins system ist fehlgeschlagen.", e.getMessage(), e);
		}
	}
	...
	private void createUITextUserName() {
		...
		fTextUsername.setText(System.getProperty("user.name"));
		// Configure layout data
		GridData data = new GridData(SWT.NONE, SWT.NONE, false, false);
		data.widthHint = F_TEXT_WIDTH_HINT;
		data.horizontalSpan = 2;
	...
	void checkOkButton() { 
		fButtonOK.setEnabled(getUserName().isEmpty());
	}
	
	String getUserName() { 
		return ( fTextUsername != null ) ? fTextUsername.getText() : "";
	}
